...
using UnityEngine;
//this script will destroy any section after passing by the player
public class DestroyCloneSubway : MonoBehaviour
{
    string parentName;
    ...
    void Update()
    {
        ...
        if (playerPosition.z > clonePosition.z + 500 && parentName == "Section(Clone)")
        {
        ...
        if (playerPosition2.z > clonePosition2.z + 500 && parentName == "Section(Clone)")
        {
            StartCoroutine(DestroyObj());
        }
